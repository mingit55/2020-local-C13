...
<div class="container padding">
    ...
    <div id="cart-list">
        <div class="w-100 py-3 text-center fx-n2 text-muted">장바구니에 담긴 상품이 없습니다.</div>
    </div>
...
<div class="bg-gray">
    <div class="container padding">
        <div class="sticky-top mt-4 bg-gray d-between align-items-end pb-3 border-bottom mb-4">
            <div>
                ...
                <div id="drop-area">
                    <div class="text-center text-white">
                        <div class="success position-center">
                            ...
                            <p class="mt-3 fx-n2 text-nowrap">상품이 장바구니에 담겼습니다!</p>
                        </div>
        ...
        <div id="store-list" class="row">
            <div class="w-100 py-3 text-center fx-n2 text-muted">일치하는 상품이 없습니다.</div>
        </div>
    </div>
</div>
<!-- /스토어 영역 -->
        ...
        <form>
            <div class="modal-content">
                <div class="modal-body px-4 pt-4 pb-3">
                    <div class="text-center title">BUY ITEM</div>
                    <div class="mt-3">
